# Sub-Talisman-Struct Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Sub-Talisman-Struct)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Sub-Talisman-Struct)
